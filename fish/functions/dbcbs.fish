function dbcbs
    ...
    data-access sql execute-read-query "set personio.company_id to -1; select * from cb_subscriptions where company_id=$COMPANY_ID" --db-identifier=chargebee-service --db-name=chargebee-service --jira-ticket=SM-981
