...
" Scroll up/down faster with Ctrl E and Ctrl Y
nnoremap <C-e> 10<C-e>
nnoremap <C-y> 10<C-y>
...
" Set tab size for HTML, Javascript and Typescript
...
" Having long update time (default 4s) leads to noticeable delays and poor UX
set updatetime=300
